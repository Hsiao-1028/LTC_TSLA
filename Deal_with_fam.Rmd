...
write.table(fam, file = "fam_v4.csv", sep = ",") # include partners
...
```{r}
# matching 
fam<- read.csv("/Users/Ano/Desktop/HRS_Chao/LTC_TSLA/fam_v4.csv") # added spouse and iadl 
...
# test<- test[0<age &age <98 | education !=88] # 扣除大概 2000筆
test<- test[0<age & age<98 & education !=88] # 扣除大概20000筆
...
detect<- function(x,y,z,u,data =data ,ID ="ID"){
...
detect(1996,1999,2003,2007, data, "ID")
...
spouses<- percise[, c("qser_no","survey_year", "ID","k_group", "problem","relationship","gender","age","edu","education","work","marstat","livstat","livwhere","meet","tele","adl_who_help", "iadl_who_help")]
...
re_detect(1996,1999,2003,2007) # is a mess的人
...
elders_all <- try
elders<- try[, c("qser_no","survey_year", "ID","k_group", "problem","relationship","gender","age","edu","education","work","marstat","livstat","livwhere","meet","tele","adl_who_help", "iadl_who_help")]
...
try <- rbind(percise, rescue_1, rescue_2, fill=TRUE)
same_gen_all<- try
same_gen<- try[, c("qser_no","survey_year", "ID","k_group", "problem","relationship","gender","age","edu","education","work","marstat","livstat","livwhere","meet","tele","adl_who_help", "iadl_who_help")]
...
try <- rbind(percise, rescue_1, rescue_2, fill=TRUE)
son_1_all <-try
son_1<- try[, c("qser_no","survey_year", "ID","k_group", "problem","relationship","gender","age","edu","education","work","marstat","livstat","livwhere","meet","tele","adl_who_help", "iadl_who_help")]
...
try <- rbind(percise, rescue_1, rescue_2, fill=TRUE)
son_2_all <-try
son_2<- try[, c("qser_no","survey_year", "ID","k_group", "problem","relationship","gender","age","edu","education","work","marstat","livstat","livwhere","meet","tele","adl_who_help", "iadl_who_help")]
...
try <- rbind(percise, rescue_1, rescue_2, fill=TRUE)
daughters_1<- try[, c("qser_no","survey_year", "ID","k_group", "problem","relationship","gender","age","edu","education","work","marstat","livstat","livwhere","meet","tele","adl_who_help", "iadl_who_help")]
...
try <- rbind(percise, rescue_1, rescue_2, fill=TRUE)
daughter_2_all <- try
daughters_2<- try[, c("qser_no","survey_year", "ID","k_group", "problem","relationship","gender","age","edu","education","work","marstat","livstat","livwhere","meet","tele","adl_who_help", "iadl_who_help")]
...
try <- rbind(percise, rescue_1, rescue_2, fill=TRUE)
next_gen_all <- try
next_gen<- try[, c("qser_no","survey_year", "ID","k_group", "problem","relationship","gender","age","edu","education","work","marstat","livstat","livwhere","meet","tele","adl_who_help", "iadl_who_help")]
...
daughters_in_law<- try[, c("qser_no","survey_year", "ID","k_group", "problem","relationship","gender","age","edu","education","work","marstat","livstat","livwhere","meet","tele","adl_who_help", "iadl_who_help")]
...
try <- rbind(percise, rescue_1, rescue_2, fill=TRUE)
others<- try[, c("qser_no","survey_year", "ID","k_group", "problem","relationship","gender","age","edu","education","work","marstat","livstat","livwhere","meet","tele","adl_who_help", "iadl_who_help")]
...
fam_re <- rbind(spouses, elders,same_gen, son_1, son_2, daughters_1, daughters_2, daughters_in_law, next_gen, others)
...
write.table(fam_re, file = "family_member_0808.csv", sep = ",") 
