...
cols<- c(unlist( lapply(paste0("^", 0:29,"_"), function(x){grep(x, names(dt_96_y), value = T)})))
class(cols)
...
cols<- unlist(lapply(0:29, function(x){paste0(x,liv)}))
cols<- append(c("ser_no", "survey_year", "qtype", 'adl_who_help', 'iadl_who_help'), cols)
tt<- dt_96_y[, .SD, .SDcols=cols ] 

x<- list( c(paste0(0:29, "_relation")), c(paste0(0:29, "_gender")), c(paste0(0:29, "_age")), c(paste0(0:29,"_edu")), c(paste0(0:29, "_work")), c(paste0(0:29, "_marstat")), c(paste0(0:29, "_livstat")), c(paste0(0:29, "_livwhere")), c(paste0(0:29, "_meet")), c(paste0(0:29, "_tele")))
