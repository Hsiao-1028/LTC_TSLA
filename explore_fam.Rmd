...
subject<- read.csv("/Users/Ano/Desktop/HRS_Chao/LTC_TSLA/main_subject_0807.csv")
fam<- read.csv("/Users/Ano/Desktop/HRS_Chao/LTC_TSLA/family_member_0808.csv")
...
s<- as.data.table(table(sort(subject[adl_who_help!=88]$adl_who_help)))
t<- fam[, main_giver := ifelse( relationship == adl_who_help, 1, 0)][ main_giver ==1] #目前只有match 到 824筆
t<- as.data.table(table(sort(t$adl_who_help)))

setnames(t, "N", "main_giver_match")
