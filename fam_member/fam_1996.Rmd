...
# dt_96_o[, "0_age":= ifelse( dt_96_y$"0_age" %in% c(-13, -14), 999, dt_96_y$"0_age" )]  # 去掉88, 98, 99 為不適用與missing # 123個NAs
...
dt_96_y[, "0_age":= ifelse(dt_96_y$"0_age" == -3, as.numeric(as.character(dt_96_y$f02a1202)), dt_96_y$"0_age")] # missing 也是很多
