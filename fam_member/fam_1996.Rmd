...
cols<- c(unlist( lapply(paste0("^", 0:31,"_"), function(x){grep(x, names(dt_96_o), value = T)})))
class(cols)
...
setnames(dt_96_y, c("fb19110","f23b2010","f23b2110","f23b2210","f23b2310","f23b2410","f23b2510","f23b2610","f23b2710"),c("30_relation","30_gender","30_age","30_edu","30_work","30_marstat","30_livwhere","30_meet","30_tele"))
...
cols<- unlist(lapply(0:31, function(x){paste0(x,liv)}))
cols<- append(c("ser_no", "survey_year", "qtype", 'adl_who_help', 'iadl_who_help'), cols)
tt<- dt_96_o[, .SD, .SDcols=cols ] 

x<- list( c(paste0(0:31, "_relation")), c(paste0(0:31, "_gender")), c(paste0(0:31, "_age")), c(paste0(0:31,"_edu")), c(paste0(0:31, "_work")), c(paste0(0:31, "_marstat")), c(paste0(0:31, "_livstat")), c(paste0(0:31, "_livwhere")), c(paste0(0:31, "_meet")), c(paste0(0:31, "_tele")))

dt_96o_reshape <- reshape(tt, varying =x , direction = "long", timevar = "ID_i", idvar = c("ser_no", "survey_year", "qtype", 'adl_who_help', 'iadl_who_help') , v.names = c("relationship","gender","age","edu","work","marstat","livstat","livwhere","meet","tele"))
...
x<- list( c(paste0(0:30, "_relation")), c(paste0(0:30, "_gender")), c(paste0(0:30, "_age")), c(paste0(0:30,"_edu")), c(paste0(0:30, "_work")), c(paste0(0:30, "_marstat")), c(paste0(0:30, "_livstat")), c(paste0(0:30, "_livwhere")), c(paste0(0:30, "_meet")), c(paste0(0:30, "_tele")))

dt_96y_reshape <- reshape(tt, varying =x , direction = "long", timevar = "ID_i", idvar = c("ser_no", "survey_year", "qtype", 'adl_who_help', 'iadl_who_help') , v.names = c("relationship","gender","age","edu","work","marstat","livstat","livwhere","meet","tele"))
