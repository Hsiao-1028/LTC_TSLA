...
fmlymmb.dt <- as.data.table(read.csv("/Users/hsiao/Desktop/Projects/HRS_Chao/LTC_TSLA/family_member_0923(NA).csv"))
```
...
### Spouses' Problem
```{r}
# 妻子的製造過程： 全部都做2，再用關係（不是夫妻）去刪掉妻子，所以這些多出來的妻子蠻有可能是沒刪掉的妻子
fmlymmb.dt<- fmlymmb.dt[! (fmlymmb.dt$relationship ==2 & fmlymmb.dt$ObsPartnerY == 0)]
