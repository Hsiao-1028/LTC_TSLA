...
dt2<- copy(dt)
dt2[, c('general', 'iadl_receive_help', 'height', 'weight'):= NULL]
# demog
...
dt2[, ethn := dt2$ethnicty][, ethnicty :=NULL]
...
# Diseases
dt2[, hibp:= as.numeric( as.character(dt2$hibp))]
dt2[, diab:= as.numeric( as.character(dt2$diab))]
