...
write.table(fam, file = "fam_v5.csv", sep = ",") # include childrens
...
```{r}
# matching 
fam<- read.csv("/Users/hsiao/Desktop/Projects/HRS_Chao/LTC_TSLA/fam_v5.csv") # added spouse and iadl and children
...
write.table(fam_re, file = "family_member_0820_all_spouse.csv", sep = ",") 
