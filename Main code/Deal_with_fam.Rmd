...
write.table(fam, file = "undetected_fam_v6.csv", sep = ",") 
...
```{r}
# matching 
fam<- read.csv("/Users/hsiao/Desktop/Projects/HRS_Chao/LTC_TSLA/Main code/undetected_fam_v6.csv") # added spouse and iadl and children
...
fam_re <- rbind(full_spouses, elders,same_gen, son_1, son_2, daughters_1, daughters_2, daughters_in_law, next_gen,youngs, others, fill = TRUE)
...
# write.csv(fam_super_na, "family_member_1004.csv")
...
fam_super_na<- read.csv("/Users/hsiao/Desktop/Projects/HRS_Chao/LTC_TSLA/Archive/family_member_1005.csv")
subject<- read.csv("/Users/hsiao/Desktop/Projects/HRS_Chao/LTC_TSLA/Archive/main_subject_0820.csv")
...
# write.csv(fam_super_na, "family_member_1010.csv")
# write.csv(subject, "main_subject_1010.csv")
