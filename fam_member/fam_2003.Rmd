...
dt_03y[, "0_age":= ifelse(dt_03y$`0_age` == 4, as.numeric(as.character(dt_03y$a15y)), dt_03y$`0_age`)]
dt_03y[, "0_age":= ifelse(dt_03y$`0_age` == 88, 92- as.numeric(as.character(dt_03y$a15roc)), dt_03y$`0_age`)]
dt_03y[, "0_age":= ifelse(dt_03y$"0_age" %in% c(98, -6, -7, 4), NA,dt_03y$"0_age" )]
...
dt_03y[, "0_marstat":= 1]
dt_03y[, "0_children":= as.numeric(as.character(dt_03y$b1))]
dt_03y[, "0_livstat":= 8][a13 == "1", "0_livstat":= ifelse(a13a == "1", 0, 1)]
dt_03y[, "0_livwhere":= 0]["0_livstat" == 1, "0_livwhere" := 99]
dt_03y[, "0_meet":= 0]["0_livstat" == 1, "0_meet" := 99]
dt_03y[, "0_tele":= 0]["0_livstat" == 1, "0_tele" := 99]
...
for(i in 1:5){setnames(dt_03y, paste0( "b10a0", i), paste0(i ,"_children"))}
...
for(i in 11:18){setnames(dt_03y, paste0( "b10a", i), paste0(i-5 ,"_children"))}
...
dt_03y[, paste0(14:25, "_children"):= 99, ] #沒有問其他家戶成員的小孩數量
...
dt_03o[,"qser_no":= paste0(dt_03o$qtype, dt_03o$ser_no)]

survive<- intersect(dt_03o$qser_no, dt_99$qser_no)
missing<- dt_03o$qser_no[! dt_03o$qser_no %in% survive]  # 
...
ss<- dt_99[qser_no %in% survive, c("qser_no","0_age", "0_edu")]
...
s_89[, old_age := as.numeric(as.character(old_age)) +10 ] # age補到99年
setnames(s_96, c("qser_no", "0_age", "0_edu"), c("qser_no", "old_age", "old_edu"))
s_96[, old_age := as.numeric(as.character(old_age)) +3 ] # age補到99年
setnames(ss, c("qser_no", "0_age", "0_edu"), c("qser_no", "old_age", "old_edu"))

ss<- as.data.table(rbind(ss, rbind(s_89, s_96)))
setnames(ss, c("qser_no", "old_age", "old_edu"), c("qser_no", "99age", "99edu"))
dt_03o<- ss[dt_03o, on="qser_no"]
...
dt_03o[, "0_marstat":= 1]
dt_03o[, "0_children":= as.numeric(as.character(b1_5))]
dt_03o[, "0_livstat":= 0][a1a =="1", "0_livstat":= ifelse(a2a == 1, 0, 1)]
dt_03o[, "0_livwhere":= 0]
dt_03o[, "0_meet":= 0][a1a =="1" & "0_livstat" == "1", "0_livstat":= as.numeric(as.character(a2c))]
dt_03o[, "0_tele":= 0]

# 新結婚的人
dt_03o[ a1a =="4" , "0_gender":= ifelse(dt_03o[a1a =="4"]$sex ==1, 2, 1)]
dt_03o[ a1a =="4" , "0_age":= as.numeric( as.character(a73))]
dt_03o[ a1a =="4" , "0_edu":= as.numeric( as.character(a9))]
...
for(i in 1:5){setnames(dt_03o, paste0( "b10a0", i), paste0(i ,"_children"))}
...
for(i in 11:18){setnames(dt_03o, paste0( "b10a", i), paste0(i-5 ,"_children"))}
...
dt_03o[, paste0(14:25, "_children"):= 99, ] #沒有問其他同住家戶成員的小孩數量
...
x<- list( c(paste0(0:25, "_relation")), c(paste0(0:25, "_gender")), c(paste0(0:25, "_age")), c(paste0(0:25,"_edu")), c(paste0(0:25, "_work")), c(paste0(0:25, "_marstat")), c(paste0(0:25, "_children")), c(paste0(0:25, "_livstat")), c(paste0(0:25, "_livwhere")), c(paste0(0:25, "_meet")), c(paste0(0:25, "_tele")))

dt_03y_reshape <- reshape(tt, varying =x , direction = "long", timevar = "ID_i", idvar = c("ser_no", "survey_year", "qtype","adl_who_help", "iadl_who_help") , v.names = c("relationship","gender","age","edu","work","marstat","children","livstat","livwhere","meet","tele"))
...
dt_03o_reshape <- reshape(tt, varying =x , direction = "long", timevar = "ID_i", idvar = c("ser_no", "survey_year", "qtype","adl_who_help", "iadl_who_help") , v.names = c("relationship","gender","age","edu","work","marstat","children","livstat","livwhere","meet","tele"))
...
# fam_03[, qser_no := paste0(qtype, ser_no)]
# 
# demo_03o<- as.data.table(demo_dt_03o)
# demo_dt_03o[, qser_no := paste0(qtype, ser_no)]
# 
# demo_03y<- as.data.table(demo_dt_03y)
# demo_dt_03y[, qser_no := paste0(qtype, ser_no)]
# 
# unmarried<- demo_dt_03y[marstat !=1]$qser_no
# 
# table(fam_03[ qser_no %in% unmarried & relationship ==2]$work)
# s<- fam_03[ qser_no %in% unmarried & relationship ==2]$qser_no
# 
# table(demo_dt_03y[qser_no %in% s]$marstat)
# 
# # 全部都是同居老伴
